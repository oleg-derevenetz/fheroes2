...
set PKG_FILE_SHA256=059458548C6E8FD04C8C82CF116B0E7D91FAF28562954978449EA36534D815A1
set PKG_URL=https://github.com/oleg-derevenetz/fheroes2-prebuilt-deps/releases/download/windows-deps/%PKG_FILE%
